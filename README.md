...
Я бы сказал, это одна из самых сложных частей, ведь нам предстоит решить сразу несколько задач. Начнем с простого, трансляции **push r_x**, где r_x это один из регистров виртуального процессора (rax, rcx, rdx, rbx). 
