...
В моем процессоре была реализована возможность пушить числа в сумме с регистром, разберем на примере **push rax + 10.0**. В этом случае трансляции производится так, сначала с помощью **movsd** мы загружаем 10 и rax в регистры xmm0 и xmm1 соответственно, затем ассемблерной командой **addsd** складываем их и пушим результат.    
